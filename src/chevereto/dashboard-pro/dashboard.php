    ...
    <div class="content-width">
        ...
        <div class="form-content">
                ...
                <div class="dashboard-group">
                    <div class="overflow-auto text-align-center margin-top-20">
                        ...
                        <div class="stats-block c6 fluid-column display-inline-block">
                            <div class="stats-big-number">
                                <strong class="number"><?php echo get_totals_display()['disk']['used']; ?>
                                    <span><?php echo get_totals_display()['disk']['unit']; ?></span></strong>
                    ...
                    <ul class="tabbed-content-list table-li margin-top-20">
                        ...
                        foreach (get_system_values() as $v) {
                            ?>
                            <li><span class="c6 display-table-cell padding-right-10"><?php echo $v['label']; ?><span
                                            style="opacity: 0;">:</span></span><span
                                        class="display-table-cell"><?php echo $v['content']; ?></span></li>
                            <?php
                        }
                        ?>
                    </ul>
            ...
            ?>
                    ...
                    <div class="header-content-right phone-float-none">
                        <div class="list-selection header--centering">
                            <a class="header-link" data-modal="form"
                               data-target="modal-add-import"><?php _se('Add import job'); ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div data-modal="modal-process-import" data-prompt="skip" class="hidden"
                     data-load-fn="CHV.fn.import.process.load" data-submit-fn="CHV.fn.import.process.submit"
                     data-ajax-deferred="CHV.fn.import.process.deferred">
                    <!-- data-modal="form" data-target="modal-process-import" -->
                ...
                <script>
                    $(document).ready(function () {
                        CHV.obj.import = {
                            ...
                            aborted: [],
                            importTpl: <?php echo json_encode($importTpl); ?>,
                            importTr: {
                                'id': null,
                                // 'object' : null,
                                'status': null,
                        ...
                        CHV.fn.import = {
                            ...
                            process: {
                                ...
                                deferred: {
                                    success: function (XHR) {
                                        ...
                                        // }
                                        CHV.fn.import.process.xhr(response.import.id, 1); // Cap to 1 thread
                            ...
                            parseTemplate: function (dataset) {
                                var tpl = CHV.obj.import.importTpl;
                        ...
                        // TODO: Check imports status on load (detect last update time)
                        $(document).on("click", CHV.obj.import.sel.root + " [data-action]", function () {
                            ...
                            if ($.compare(localData, backupData) == false) {
                                ...
                                $.ajax({
                                    ...
                                    var response = XHR.responseJSON;
                                    var dataset = typeof response.import != typeof undefined ? response.import : localData;
                                    var $html = CHV.fn.import.parseTemplate(dataset);
                                    $el.replaceWith($html);
                                    // PF.fn.growl.expirable("Import job ID " + localData.id + " updated");
                ...
                <div class="header header-tabs margin-bottom-10 follow-scroll">
                    ...
                    <?php if (get_dashboard() == 'users') {
                        ...
                        <div class="header-content-right phone-float-none">
                            <div class="list-selection header--centering">
                                <a class="header-link" data-modal="form"
                                   data-target="modal-add-user"><?php _se('Add user'); ?></a>
                            </div>
                        </div>
                        <div data-modal="modal-add-user" class="hidden" data-submit-fn="CHV.fn.user.add.submit"
                             data-ajax-deferred="CHV.fn.user.add.complete">
                            ...
                            <div class="modal-form">
                                ...
                                <div class="input-label c11">
                                    ...
                                    <input type="text" name="form-username" id="form-username" class="text-input"
                                           maxlength="<?php echo CHV\Settings::get('username_max_length'); ?>"
                                           rel="tooltip" data-tipTip="right"
                                           pattern="<?php echo CHV\Settings::get('username_pattern'); ?>" rel="tooltip"
                                           data-title='<?php echo strtr('%i to %f characters<br>Letters, numbers and "_"', ['%i' => CHV\Settings::get('username_min_length'), '%f' => CHV\Settings::get('username_max_length')]); ?>'
                                           maxlength="<?php echo CHV\Settings::get('username_max_length'); ?>"
                                ...
                                <div class="input-label c11">
                                    ...
                                    <input type="email" name="form-email" id="form-email" class="text-input"
                                           placeholder="<?php _se('Email address'); ?>" required>
                                    <span class="input-warning red-warning"></span>
                                </div>
                                <div class="input-label c11">
                                    <label for="form-name"><?php _se('Password'); ?></label>
                                    <input type="password" name="form-password" id="form-password" class="text-input"
                                           title="<?php _se('%d characters min', CHV\Settings::get('user_password_min_length')); ?>"
                                           pattern="<?php echo CHV\Settings::get('user_password_pattern'); ?>"
                                           rel="tooltip" data-tipTip="right" placeholder="<?php _se('Password'); ?>"
                                           required>
                                    <span class="input-warning red-warning"></span>
                                </div>
                            </div>
            ...
            ?>
                <form id="dashboard-settings" method="post" data-type="<?php echo get_dashboard(); ?>"
                      data-action="validate" enctype="multipart/form-data">
                    ...
                    <div class="header header--centering default-margin-bottom">
                        ...
                        <div data-content="pop-selection"
                             class="pop-btn pop-keep-click header-link float-left margin-left-10"
                             data-action="settings-switch">
                            <span class="pop-btn-text margin-left-5"><?php echo get_settings()['label']; ?><span
                        ...
                        <?php if (get_settings()['key'] == 'categories') {
                            ...
                            <div class="header-content-right phone-float-none">
                                <div class="list-selection header--centering">
                                    <a class="header-link" data-modal="form"
                                       data-target="modal-add-category"><?php _se('Add category'); ?></a>
                                </div>
                            </div>
                            <div data-modal="modal-add-category" class="hidden"
                                 data-submit-fn="CHV.fn.category.add.submit" data-before-fn="CHV.fn.category.add.before"
                                 data-ajax-deferred="CHV.fn.category.add.complete">
                        ...
                        <?php if (get_settings()['key'] == 'ip-bans') {
                            ...
                            <div class="header-content-right phone-float-none">
                                <div class="list-selection header--centering">
                                    <a class="header-link" data-modal="form"
                                       data-target="modal-add-ip_ban"><?php _se('Add IP ban'); ?></a>
                                </div>
                            </div>
                            <div data-modal="modal-add-ip_ban" class="hidden" data-submit-fn="CHV.fn.ip_ban.add.submit"
                                 data-before-fn="CHV.fn.ip_ban.add.before"
                                 data-ajax-deferred="CHV.fn.ip_ban.add.complete">
                        ...
                        <?php if (get_settings()['key'] == 'external-storage') {
                            ...
                            <div class="header-content-right phone-float-none">
                                <div class="list-selection header--centering">
                                    <a class="header-link" data-modal="form"
                                       data-target="modal-add-storage"><?php _se('Add storage'); ?></a>
                                </div>
                            </div>
                            <div data-modal="modal-add-storage" class="hidden"
                                 data-submit-fn="CHV.fn.storage.add.submit" data-before-fn="CHV.fn.storage.add.before"
                                 data-ajax-deferred="CHV.fn.storage.add.complete">
                        ...
                        if (get_settings()['key'] == 'pages') {
                            ...
                            <div class="header-content-right phone-hide">
                                <div class="list-selection header--centering">
                                    <a class="header-link"
                                       href="<?php echo G\get_base_url($pages_top_link['href']); ?>"><?php echo $pages_top_link['text']; ?></a>
                                </div>
                            </div>
                            <?php
                        } ?>
                    ...
                    if (get_dashboard() == 'settings') {
                        ...
                        <div class="phablet-c1">
                            <div class="input-label">
                                ...
                                <input type="text" name="website_name" id="website_name" class="text-input"
                                       value="<?php echo G\safe_html(CHV\Settings::get('website_name')); ?>" required>
                            ...
                            <div class="input-label">
                                ...
                                <input type="text" name="website_doctitle" id="website_doctitle" class="text-input"
                                       value="<?php echo G\safe_html(CHV\Settings::get('website_doctitle')); ?>">
                            </div>
                            <div class="input-label">
                                <label for="website_description"><?php _se('Website description'); ?></label>
                                <input type="text" name="website_description" id="website_description"
                                       class="text-input"
                                       value="<?php echo G\safe_html(CHV\Settings::get('website_description')); ?>">
                    ...
                    <hr class="line-separator">
                        ...
                        <div class-="phablet-c1">
                            <div class="input-label">
                                ...
                                <div class="c5 phablet-c1"><select type="text" name="enable_powered_by"
                                                                   id="enable_powered_by" class="text-input">
                                        <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="phablet-c1">
                            <div class="input-label">
                                ...
                                <div class="c5 phablet-c1"><select type="text" name="website_https" id="website_https"
                                                                   class="text-input">
                                        <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="overflow-auto">
                                ...
                                <div id="timezone-combo" class="c5 phablet-c1 grid-columns">
                                    ...
                                    foreach ($regions as $key => $region) {
                                        ...
                                        <select id="timezone-combo-<?php echo $key; ?>"
                                                class="text-input switch-combo<?php echo $show_hide; ?>"
                                                data-combo-value="<?php echo $key; ?>">
                                            <?php
                            ...
                            <input type="hidden" id="default_timezone" name="default_timezone" data-content="timezone"
                                   data-highlight="#timezone-region"
                                   value="<?php echo CHV\Settings::get('default_timezone', true); ?>" required>
                        </div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="website_search" id="website_search"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="website_explore_page"
                                                               id="website_explore_page" class="text-input"
                                                               data-combo="website-explore-combo">
                                    <?php
                        ...
                        <div id="website-explore-combo">
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="website_explore_page_guest"
                                                                       id="website_explore_page_guest"
                                                                       class="text-input">
                                            <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="website_random" id="website_random"
                                                               class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="website_mode" id="website_mode"
                                                               class="text-input" data-combo="website-mode-combo">
                                    <?php
                        ...
                        <div id="website-mode-combo">
                            ...
                            <div data-combo-value="personal"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="1" name="website_mode_personal_uid"
                                                           id="website_mode_personal_uid" class="text-input"
                                                           value="<?php echo CHV\Settings::get('website_mode_personal_uid'); ?>"
                                                           placeholder="<?php _se('User ID'); ?>" rel="tooltip"
                                                           title="<?php _se('Your user id is: %s', CHV\Login::getUser()['id']); ?>"
                                                           data-tipTip="right" data-required></div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5"><input type="text" name="website_mode_personal_routing"
                                                           id="website_mode_personal_routing" class="text-input"
                                                           value="<?php echo CHV\Settings::get('website_mode_personal_routing'); ?>"
                                                           placeholder="/"></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="website_privacy_mode"
                                                               id="website_privacy_mode" class="text-input"
                                                               data-combo="website-privacy-mode-combo">
                                    <?php
                            ...
                            <div data-combo-value="private"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="website_content_privacy_mode"
                                                                       id="website_content_privacy_mode"
                                                                       class="text-input">
                                            <?php
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="text" name="page_title" id="page_title"
                                                              class="text-input"
                                                              value="<?php echo get_page_val('page_title'); ?>" required
                                                              placeholder="<?php _se('Page title'); ?>"></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="page_type" id="page_type"
                                                               class="text-input" data-combo="page-type-combo">
                                    <?php
                        ...
                        <div id="page-type-combo">
                            ...
                            <div data-combo-value="internal"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="page_internal"
                                                                       id="page_internal" class="text-input">
                                            <?php
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="page_is_link_visible"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c9 phablet-c1"><input type="text" name="page_url_key" id="page_url_key"
                                                                      class="text-input"
                                                                      value="<?php echo get_page_val('page_url_key'); ?>"
                                                                      pattern="^[\w]([\w-]*[\w])?(\/[\w]([\w-]*[\w])?)*$"
                                                                      rel="tooltip" data-tiptip="right"
                                                                      placeholder="url-key"
                                                                      title="<?php _se('Only alphanumerics, hyphens and forward slash'); ?>" <?php echo $page_internal_combo_visible ? 'required' : 'data-required'; ?>>
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c9 phablet-c1"><input type="text" name="page_file_path"
                                                                      id="page_file_path" class="text-input"
                                                                      value="<?php echo get_page_val('page_file_path'); ?>"
                                                                      pattern="^[\w]([\w-]*[\w])?(\/[\w]([\w-]*[\w])?)*\.<?php echo G\get_app_setting('disable_php_pages') ? 'html' : 'php'; ?>$" <?php echo $page_internal_combo_visible ? 'required' : 'data-required'; ?>
                                                                      placeholder="page.<?php echo G\get_app_setting('disable_php_pages') ? 'html' : 'php'; ?>">
                                    </div>
                                ...
                                <div class="input-label">
                                    <label for="page_keywords"><?php _se('Meta keywords'); ?> <span
                                                class="optional"><?php _se('optional'); ?></span></label>
                                    <div class="c9 phablet-c1"><input type="text" name="page_keywords"
                                                                      id="page_keywords" class="text-input"
                                                                      value="<?php echo get_page_val('page_keywords'); ?>">
                                    </div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['page_keywords']; ?></div>
                                </div>

                                <div class="input-label">
                                    <label for="page_description"><?php _se('Meta description'); ?> <span
                                                class="optional"><?php _se('optional'); ?></span></label>
                                    <div class="c9 phablet-c1"><textarea type="text" name="page_description"
                                                                         id="page_description"
                                                                         class="text-input resize-vertical r2"><?php echo get_page_val('page_description'); ?></textarea>
                                    </div>
                            ...
                            <div data-combo-value="link"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c9 phablet-c1"><input type="url" name="page_link_url" id="page_link_url"
                                                                      class="text-input"
                                                                      value="<?php echo get_page_val('page_link_url'); ?>" <?php echo get_page_val('page_type') == 'link' ? 'required' : 'data-required'; ?>>
                                    </div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="page_attr_target" id="page_attr_target"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            <label for="page_attr_rel"><?php _se('Link rel attribute'); ?> <span
                                        class="optional"><?php _se('optional'); ?></span></label>
                            <div class="c9 phablet-c1"><input type="text" name="page_attr_rel" id="page_attr_rel"
                                                              class="text-input" pattern="[\w\s\-]+"
                                                              value="<?php echo get_page_val('page_attr_rel'); ?>"
                                                              rel="tooltip" data-tiptip="right"
                                                              title="<?php _se('Only alphanumerics, hyphens and whitespaces'); ?>">
                            </div>
                        ...
                        <div class="input-label">
                            <label for="page_icon"><?php _se('Link icon'); ?> <span
                                        class="optional"><?php _se('optional'); ?></span></label>
                            <div class="c9 phablet-c1"><input type="text" name="page_icon" id="page_icon"
                                                              class="text-input" pattern="[\w\s\-]+"
                                                              value="<?php echo get_page_val('page_icon'); ?>"
                                                              rel="tooltip" data-tiptip="right"
                                                              title="<?php _se('Only alphanumerics, hyphens and whitespaces'); ?>">
                            </div>
                        ...
                        <div class="input-label">
                            <label for="page_sort_display"><?php _se('Sort order display'); ?> <span
                                        class="optional"><?php _se('optional'); ?></span></label>
                            <div class="c3 phablet-c1"><input type="number" min="1" name="page_sort_display"
                                                              id="page_sort_display" class="text-input"
                                                              value="<?php echo get_page_val('page_sort_display'); ?>">
                            </div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_uploads" id="enable_uploads"
                                                               class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_show_embed_uploader"
                                                               id="theme_show_embed_uploader" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c2"><input type="number" min="1" max="5" pattern="\d+" name="upload_threads"
                                                   id="upload_threads" class="text-input"
                                                   value="<?php echo CHV\Settings::get('upload_threads'); ?>"
                                                   placeholder="2" required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_redirect_single_upload"
                                                               id="enable_redirect_single_upload" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_duplicate_uploads"
                                                               id="enable_duplicate_uploads" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_expirable_uploads"
                                                               id="enable_expirable_uploads" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="auto_delete_guest_uploads"
                                                               id="auto_delete_guest_uploads" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            <label for="upload_max_image_width"
                                   class="display-block-forced"><?php _se('Maximum image size'); ?></label>
                            <div class="c5 overflow-auto clear-both">
                                <div class="c2 float-left">
                                    <input type="number" min="0" pattern="\d+" name="upload_max_image_width"
                                           id="upload_max_image_width" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['upload_max_image_width'] : CHV\Settings::get('upload_max_image_width'); ?>"
                                           placeholder="<?php echo CHV\Settings::getDefault('upload_max_image_width'); ?>"
                                           rel="tooltip" data-tiptip="top" title="<?php _se('Width'); ?>" required>
                                </div>
                                <div class="c2 float-left margin-left-10">
                                    <input type="number" min="0" pattern="\d+" name="upload_max_image_height"
                                           id="upload_max_image_height" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['upload_max_image_height'] : CHV\Settings::get('upload_max_image_height'); ?>"
                                           placeholder="<?php echo CHV\Settings::getDefault('upload_max_image_height'); ?>"
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="upload_image_exif"
                                                               id="upload_image_exif" class="text-input">
                                    <?php
                                    echo CHV\Render\get_select_options_html([
                                        1 => _s('Keep'),
                                        0 => _s('Remove'),
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="upload_image_exif_user_setting"
                                                               id="upload_image_exif_user_setting" class="text-input">
                                    <?php
                                    echo CHV\Render\get_select_options_html([
                                        1 => _s('Enabled'),
                                        0 => _s('Disabled'),
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c2"><input type="number" min="0.1" step="0.1"
                                                   max="<?php echo G\bytes_to_mb(CHV\Settings::get('true_upload_max_filesize')); ?>"
                                                   pattern="\d+" name="upload_max_filesize_mb"
                                                   id="upload_max_filesize_mb" class="text-input"
                        ...
                        <div class="input-label">
                            <label for="upload_max_filesize_mb_guest"><?php _se('Maximum upload file size'); ?>
                                (<?php _se('guests'); ?>)</label>
                            <div class="c2"><input type="number" min="0.1" step="0.1"
                                                   max="<?php echo G\bytes_to_mb(CHV\Settings::get('true_upload_max_filesize')); ?>"
                                                   pattern="\d+" name="upload_max_filesize_mb_guest"
                                                   id="upload_max_filesize_mb_guest" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['upload_max_filesize_mb_guest'] : CHV\Settings::get('upload_max_filesize_mb_guest'); ?>"
                                                   placeholder="MB" required></div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="text" name="upload_image_path"
                                                              id="upload_image_path" class="text-input"
                                                              value="<?php echo get_safe_post() ? get_safe_post()['upload_image_path'] : CHV\Settings::get('upload_image_path'); ?>"
                                                              placeholder="<?php _se('Relative to Chevereto root'); ?>"
                                                              required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="upload_storage_mode"
                                                               id="upload_storage_mode" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="upload_filenaming"
                                                               id="upload_filenaming" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            <label for="upload_thumb_width"
                                   class="display-block-forced"><?php _se('Thumb size'); ?></label>
                            <div class="c5 overflow-auto clear-both">
                                <div class="c2 float-left">
                                    <input type="number" min="16" pattern="\d+" name="upload_thumb_width"
                                           id="upload_thumb_width" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['upload_thumb_width'] : CHV\Settings::get('upload_thumb_width'); ?>"
                                           placeholder="<?php echo CHV\Settings::getDefault('upload_thumb_width'); ?>"
                                           rel="tooltip" data-tiptip="top" title="<?php _se('Width'); ?>" required>
                                </div>
                                <div class="c2 float-left margin-left-10">
                                    <input type="number" min="16" pattern="\d+" name="upload_thumb_height"
                                           id="upload_thumb_height" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['upload_thumb_height'] : CHV\Settings::get('upload_thumb_height'); ?>"
                                           placeholder="<?php echo CHV\Settings::getDefault('upload_thumb_height'); ?>"
                                           rel="tooltip" data-tiptip="top" title="<?php _se('Height'); ?>" required>
                                </div>
                            </div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="upload_medium_fixed_dimension"
                                                               id="upload_medium_fixed_dimension" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c2">
                                <input type="number" min="16" pattern="\d+" name="upload_medium_size"
                                       id="upload_medium_size" class="text-input"
                                       value="<?php echo get_safe_post() ? get_safe_post()['upload_medium_size'] : CHV\Settings::get('upload_medium_size'); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('upload_medium_size'); ?>"
                                       required>
                            </div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="watermark_enable" id="watermark_enable"
                                                               class="text-input" data-combo="watermark-combo">
                                    <?php
                        ...
                        <div id="watermark-combo">
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    <label for="watermark_target_min_width"
                                           class="display-block-forced"><?php _se('Minimum image size needed to apply watermark'); ?></label>
                                    <div class="c5 overflow-auto clear-both">
                                        <div class="c2 float-left">
                                            <input type="number" min="0" pattern="\d+" name="watermark_target_min_width"
                                                   id="watermark_target_min_width" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['watermark_target_min_width'] : CHV\Settings::get('watermark_target_min_width'); ?>"
                                                   placeholder="<?php echo CHV\Settings::getDefault('watermark_target_min_width'); ?>"
                                                   rel="tooltip" data-tiptip="top" title="<?php _se('Width'); ?>"
                                                   required>
                                        </div>
                                        <div class="c2 float-left margin-left-10">
                                            <input type="number" min="0" pattern="\d+"
                                                   name="watermark_target_min_height" id="watermark_target_min_height"
                                                   class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['watermark_target_min_height'] : CHV\Settings::get('watermark_target_min_height'); ?>"
                                                   placeholder="<?php echo CHV\Settings::getDefault('watermark_target_min_height'); ?>"
                                                   rel="tooltip" data-tiptip="top" title="<?php _se('Height'); ?>"
                                                   required>
                                        </div>
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="watermark_position"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c2">
                                        <input type="number" min="1" max="100" pattern="\d+" name="watermark_percentage"
                                               id="watermark_percentage" class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['watermark_percentage'] : CHV\Settings::get('watermark_percentage'); ?>"
                                               placeholder="<?php echo CHV\Settings::getDefault('watermark_percentage'); ?>"
                                               required>
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c2">
                                        <input type="number" min="0" pattern="\d+" name="watermark_margin"
                                               id="watermark_margin" class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['watermark_margin'] : CHV\Settings::get('watermark_margin'); ?>"
                                               placeholder="<?php echo CHV\Settings::getDefault('watermark_margin'); ?>"
                                               required>
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c2">
                                        <input type="number" min="1" max="100" pattern="\d+" name="watermark_opacity"
                                               id="watermark_opacity" class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['watermark_opacity'] : CHV\Settings::get('watermark_opacity'); ?>"
                                               placeholder="<?php echo CHV\Settings::getDefault('watermark_opacity'); ?>"
                                               required>
                                    </div>
					...
					<span class="c2 display-table-cell"><a class="delete-link" data-category-id="%ID%" data-args="%ID%" data-confirm="' . _s("Do you really want to delete the %s category? This can't be undone.") . '" data-submit-fn="CHV.fn.category.delete.submit" data-before-fn="CHV.fn.category.delete.before" data-ajax-deferred="CHV.fn.category.delete.complete">' . _s('Delete') . '</a></span>
                        ...
                        <div data-modal="form-modal" class="hidden" data-submit-fn="CHV.fn.category.edit.submit"
                             data-before-fn="CHV.fn.category.edit.before"
                             data-ajax-deferred="CHV.fn.category.edit.complete"
                             data-ajax-url="<?php echo G\get_base_url('json'); ?>">
                    ...
                    try {
                        ...
                        <ul data-content="dashboard-ip_bans-list"
                            class="tabbed-content-list table-li table-li-hover margin-top-20 margin-bottom-20">
                            <li class="table-li-header phone-hide">
					...
					<span class="c2 display-table-cell"><a class="delete-link" data-ip_ban-id="%ID%" data-args="%ID%" data-confirm="' . _s("Do you really want to remove the ban to the IP %s? This can't be undone.") . '" data-submit-fn="CHV.fn.ip_ban.delete.submit" data-before-fn="CHV.fn.ip_ban.delete.before" data-ajax-deferred="CHV.fn.ip_ban.delete.complete">' . _s('Delete') . '</a></span>
                        ...
                        <div data-modal="form-modal" class="hidden" data-submit-fn="CHV.fn.ip_ban.edit.submit"
                             data-before-fn="CHV.fn.ip_ban.edit.before" data-ajax-deferred="CHV.fn.ip_ban.edit.complete"
                             data-ajax-url="<?php echo G\get_base_url('json'); ?>">
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_user_content_delete"
                                                               id="enable_user_content_delete" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="notify_user_signups"
                                                               id="notify_user_signups" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            <label for="user_image_avatar_max_filesize_mb"><?php _se('User avatar max. filesize'); ?>
                                (MB)</label>
                            <div class="c3"><input type="number" min="0" pattern="\d+"
                                                   name="user_image_avatar_max_filesize_mb"
                                                   id="user_image_avatar_max_filesize_mb" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['user_image_avatar_max_filesize_mb'] : CHV\Settings::get('user_image_avatar_max_filesize_mb'); ?>"
                                                   placeholder="MB" required></div>
                        ...
                        <div class="input-label">
                            <label for="user_image_background_max_filesize_mb"><?php _se('User background max. filesize'); ?>
                                (MB)</label>
                            <div class="c3"><input type="number" min="0" pattern="\d+"
                                                   name="user_image_background_max_filesize_mb"
                                                   id="user_image_background_max_filesize_mb" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['user_image_background_max_filesize_mb'] : CHV\Settings::get('user_image_background_max_filesize_mb'); ?>"
                                                   placeholder="MB" required></div>
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_consent_screen"
                                                               id="enable_consent_screen" class="text-input"
                                                               data-combo="consent-screen-combo">
                                    <?php
                        ...
                        <div id="consent-screen-combo">
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="transparent-canvas dark margin-bottom-10" style="max-width: 200px;"><img
                                                class="display-block" width="100%"
                                                src="<?php echo CHV\get_system_image_url(CHV\Settings::get('consent_screen_cover_image')); ?>">
                                    </div>
                                    <div class="c5 phablet-c1">
                                        <input id="consent_screen_cover_image" name="consent_screen_cover_image"
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="flood_uploads_protection"
                                                               id="flood_uploads_protection" class="text-input"
                                                               data-combo="flood-protection-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="flood_uploads_notify"
                                                                       id="flood_uploads_notify" class="text-input">
                                            <?php
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="0" name="flood_uploads_minute"
                                                           id="flood_uploads_minute" class="text-input"
                                                           value="<?php echo get_safe_post() ? get_safe_post()['flood_uploads_minute'] : CHV\Settings::get('flood_uploads_minute', true); ?>"
                                                           placeholder="<?php echo CHV\Settings::getDefault('flood_uploads_minute'); ?>">
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="0" name="flood_uploads_hour"
                                                           id="flood_uploads_hour" class="text-input"
                                                           value="<?php echo get_safe_post() ? get_safe_post()['flood_uploads_hour'] : CHV\Settings::get('flood_uploads_hour', true); ?>"
                                                           placeholder="<?php echo CHV\Settings::getDefault('flood_uploads_hour'); ?>">
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="0" name="flood_uploads_day"
                                                           id="flood_uploads_day" class="text-input"
                                                           value="<?php echo get_safe_post() ? get_safe_post()['flood_uploads_day'] : CHV\Settings::get('flood_uploads_day', true); ?>"
                                                           placeholder="<?php echo CHV\Settings::getDefault('flood_uploads_day'); ?>">
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="0" name="flood_uploads_week"
                                                           id="flood_uploads_week" class="text-input"
                                                           value="<?php echo get_safe_post() ? get_safe_post()['flood_uploads_week'] : CHV\Settings::get('flood_uploads_week', true); ?>"
                                                           placeholder="<?php echo CHV\Settings::getDefault('flood_uploads_week'); ?>">
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c3"><input type="number" min="0" name="flood_uploads_month"
                                                           id="flood_uploads_month" class="text-input"
                                                           value="<?php echo get_safe_post() ? get_safe_post()['flood_uploads_month'] : CHV\Settings::get('flood_uploads_month', true); ?>"
                                                           placeholder="<?php echo CHV\Settings::getDefault('flood_uploads_month'); ?>">
                                    </div>
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="show_nsfw_in_listings"
                                                               id="show_nsfw_in_listings" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_nsfw_blur" id="theme_nsfw_blur"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="show_banners_in_nsfw"
                                                               id="show_banners_in_nsfw" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="show_nsfw_in_random_mode"
                                                               id="show_nsfw_in_random_mode" class="text-input">
                                    <?php
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="c2"><input type="number" min="1" name="listing_items_per_page"
                                                   id="listing_items_per_page" class="text-input"
                                                   value="<?php echo CHV\Settings::get('listing_items_per_page', true); ?>"
                                                   placeholder="<?php echo CHV\Settings::getDefault('listing_items_per_page', true); ?>"
                                                   required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="listing_pagination_mode"
                                                               id="listing_pagination_mode" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="listing_viewer" id="listing_viewer"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_image_listing_sizing"
                                                               id="theme_image_listing_sizing" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            <label for="explore_albums_min_image_count"><?php _se('Album listing images requirement'); ?>
                                (<?php echo _se('explore'); ?>)</label>
                            <div class="c2"><input type="number" min="1" name="explore_albums_min_image_count"
                                                   id="explore_albums_min_image_count" class="text-input"
                                                   value="<?php echo CHV\Settings::get('explore_albums_min_image_count', true); ?>"
                                                   placeholder="<?php echo CHV\Settings::getDefault('explore_albums_min_image_count', true); ?>"
                                                   required></div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="overflow-auto margin-bottom-10 margin-top-10">
                                <label for="listing_columns_phone"
                                       class="c2 float-left input-line-height"><?php _se('Phone'); ?></label>
                                <input type="number" name="listing_columns_phone" id="listing_columns_phone"
                                       class="text-input c2"
                                       value="<?php echo CHV\Settings::get('listing_columns_phone', true); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('listing_columns_phone', true); ?>"
                                       pattern="\d*" min="1" max="7" required>
                            </div>
                            <div class="overflow-auto margin-bottom-10">
                                <label for="listing_columns_phablet"
                                       class="c2 float-left input-line-height"><?php _se('Phablet'); ?></label>
                                <input type="number" name="listing_columns_phablet" id="listing_columns_phablet"
                                       class="text-input c2"
                                       value="<?php echo CHV\Settings::get('listing_columns_phablet', true); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('listing_columns_phablet', true); ?>"
                                       pattern="\d*" min="1" max="8" required>
                            </div>
                            <div class="overflow-auto margin-bottom-10">
                                <label for="listing_columns_tablet"
                                       class="c2 float-left input-line-height"><?php _se('Tablet'); ?></label>
                                <input type="number" name="listing_columns_tablet" id="listing_columns_tablet"
                                       class="text-input c2"
                                       value="<?php echo CHV\Settings::get('listing_columns_tablet', true); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('listing_columns_tablet', true); ?>"
                                       pattern="\d*" min="1" max="8" required>
                            </div>
                            <div class="overflow-auto margin-bottom-10">
                                <label for="listing_columns_laptop"
                                       class="c2 float-left input-line-height"><?php _se('Laptop'); ?></label>
                                <input type="number" name="listing_columns_laptop" id="listing_columns_laptop"
                                       class="text-input c2"
                                       value="<?php echo CHV\Settings::get('listing_columns_laptop', true); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('listing_columns_laptop', true); ?>"
                                       pattern="\d*" min="1" max="8" required>
                            </div>
                            <div class="overflow-auto margin-bottom-10">
                                <label for="listing_columns_desktop"
                                       class="c2 float-left input-line-height"><?php _se('Desktop'); ?></label>
                                <input type="number" name="listing_columns_desktop" id="listing_columns_desktop"
                                       class="text-input c2"
                                       value="<?php echo CHV\Settings::get('listing_columns_desktop', true); ?>"
                                       placeholder="<?php echo CHV\Settings::getDefault('listing_columns_desktop', true); ?>"
                                       pattern="\d*" min="1" max="8" required>
                            </div>
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_tone" id="theme_tone"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c4"><input type="text" name="theme_main_color" id="theme_main_color"
                                                   class="text-input"
                                                   value="<?php echo CHV\Settings::get('theme_main_color', true); ?>"
                                                   placeholder="#00A7DA"
                                                   pattern="#?([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})"
                                                   title="<?php _se('Hexadecimal color value'); ?>" rel="toolTip"
                                                   data-tipTip="right"></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_top_bar_color"
                                                               id="theme_top_bar_color" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_top_bar_button_color"
                    ...
                    if (!is_writable(CHV_PATH_CONTENT_IMAGES_SYSTEM)) {
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="logo_vector_enable"
                                                               id="logo_vector_enable" class="text-input"
                                                               data-combo="logo-vector-combo">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c4"><input type="number" min="0" pattern="\d+" name="theme_logo_height"
                                                   id="theme_logo_height" class="text-input"
                                                   value="<?php echo CHV\Settings::get('theme_logo_height'); ?>"
                                                   placeholder="<?php _se('No value'); ?>"></div>
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            <label for="image_load_max_filesize_mb"><?php _se('Image load max. filesize'); ?>
                                (MB)</label>
                            <div class="c2"><input type="number" min="0" pattern="\d+" name="image_load_max_filesize_mb"
                                                   id="image_load_max_filesize_mb" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['image_load_max_filesize_mb'] : CHV\Settings::get('image_load_max_filesize_mb'); ?>"
                                                   placeholder="MB"></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_download_button"
                                                               id="theme_download_button" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_image_right_click"
                                                               id="theme_image_right_click" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_show_exif_data"
                                                               id="theme_show_exif_data" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_show_social_share"
                                                               id="theme_show_social_share" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_show_embed_content"
                                                               id="theme_show_embed_content" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="theme_nsfw_upload_checkbox"
                                                               id="theme_nsfw_upload_checkbox" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c12 phablet-c1"><textarea type="text" name="theme_custom_css_code"
                                                                  id="theme_custom_css_code" class="text-input r4"
                                                                  placeholder="<?php _se('Put your custom CSS code here. It will be placed as <style> just before the closing </head> tag.'); ?>"><?php echo CHV\Settings::get('theme_custom_css_code', true); ?></textarea>
                            </div>
                        </div>

                        <div class="input-label">
                            <label for="theme_custom_js_code"><?php _se('Custom JS code'); ?></label>
                            <div class="c12 phablet-c1"><textarea type="text" name="theme_custom_js_code"
                                                                  id="theme_custom_js_code" class="text-input r4"
                                                                  placeholder="<?php _se('Put your custom JS code here. It will be placed as <script> just before the closing </head> tag.'); ?>"><?php echo CHV\Settings::get('theme_custom_js_code', true); ?></textarea>
                            </div>
                        ...
                        <div id="home-style-combo">
                            <div data-combo-value="landing split"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1">
                                        <input id="homepage_cover_image_add" name="homepage_cover_image_add" type="file"
                                               accept="image/*">
                                    </div>
                                ...
                                <?php if (CHV\Settings::get('logo_vector_enable')) {
                                    ...
                                    <div class="input-label">
                                        <label for="logo_vector_homepage"><?php _se('Vector logo image'); ?> <span
                                                    class="optional"><?php _se('optional'); ?></span></label>
                                        <div class="transparent-canvas dark margin-bottom-10" style="max-width: 200px;">
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c12 phablet-c1"><textarea type="text" name="homepage_title_html"
                                                                          id="homepage_title_html"
                                                                          class="text-input r2 resize-vertical"
                                                                          placeholder="<?php echo G\safe_html(_s('This will be added inside the homepage %s tag. Leave it blank to use the default contents.', '<h1>')); ?>"><?php echo CHV\Settings::get('homepage_title_html'); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c12 phablet-c1"><textarea type="text" name="homepage_paragraph_html"
                                                                          id="homepage_paragraph_html"
                                                                          class="text-input r2 resize-vertical"
                                                                          placeholder="<?php echo G\safe_html(_s('This will be added inside the homepage %s tag. Leave it blank to use the default contents.', '<p>')); ?>"><?php echo CHV\Settings::get('homepage_paragraph_html'); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="homepage_cta_color"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="homepage_cta_outline"
                                                                       id="homepage_cta_outline" class="text-input">
                                            <?php
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="homepage_cta_fn"
                                                                       id="homepage_cta_fn" class="text-input"
                                                                       data-combo="cta-fn-combo">
                                            <?php
                                            echo CHV\Render\get_select_options_html([
                                    ...
                                    <div data-combo-value="cta-link"
                                        ...
                                        <div class="input-label">
                                            ...
                                            <div class="c9 phablet-c1"><input type="text" name="homepage_cta_fn_extra"
                                                                              id="homepage_cta_fn_extra"
                                                                              class="text-input"
                                                                              value="<?php echo CHV\Settings::get('homepage_cta_fn_extra', true); ?>"
                                                                              placeholder="<?php _se('Enter an absolute or relative URL'); ?>" <?php echo ((get_safe_post() ? get_safe_post()['homepage_cta_fn'] : CHV\Settings::get('homepage_cta_fn')) !== 'cta-link') ? 'data-required' : 'required'; ?>>
                                            </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c12 phablet-c1"><textarea type="text" name="homepage_cta_html"
                                                                          id="homepage_cta_html"
                                                                          class="text-input r2 resize-vertical"
                                                                          placeholder="<?php echo G\safe_html(_s('This will be added inside the call to action <a> tag. Leave it blank to use the default contents.')); ?>"><?php echo CHV\Settings::get('homepage_cta_html'); ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div data-combo-value="split"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c4"><input type="text" name="homepage_uids" id="homepage_uids"
                                                           class="text-input"
                                                           value="<?php echo CHV\Settings::get('homepage_uids', true); ?>"
                                                           placeholder="<?php _se('Empty'); ?>" rel="tooltip"
                                                           title="<?php _se('Your user id is: %s', CHV\Login::getUser()['id']); ?>"
                                                           data-tipTip="right"></div>
                    ...
                    foreach ($group['placements'] as $id => $banner) {
                        ...
                        <div class="input-label">
                            ...
                            <div class="c12 phablet-c1"><textarea type="text" id="<?php echo $id; ?>"
                                                                  name="<?php echo $id; ?>" class="text-input r3"
                                                                  placeholder="<?php echo $banner['placeholder']; ?>" </textarea><?php echo CHV\get_banner_code($id); ?> </textarea>
                            </div> <?php
                            if ($banner['hint']) {
                                ?>
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_automatic_updates_check"
                                                               id="enable_automatic_updates_check" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="update_check_display_notification"
                                                               id="update_check_display_notification"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="dump_update_query"
                                                               id="dump_update_query" class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="minify_enable" id="minify_enable"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="maintenance" id="maintenance"
                                                               class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><input type="text" name="crypt_salt" id="crypt_salt"
                                                              class="text-input"
                                                              value="<?php echo CHV\Settings::get('crypt_salt'); ?>"
                                                              disabled></div>
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="error_reporting" id="error_reporting"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="debug_level" id="debug_level"
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1">
                                <input type="text" name="route_image" id="route_image" class="text-input"
                                       value="<?php echo CHV\Settings::get('route_image', true); ?>" required
                                       pattern="^[a-z0-9]+(?:-[a-z0-9]+)*$" placeholder="image">
                            </div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1">
                                <input type="text" name="route_album" id="route_album" class="text-input"
                                       value="<?php echo CHV\Settings::get('route_album', true); ?>" required
                                       pattern="^[a-z0-9]+(?:-[a-z0-9]+)*$" placeholder="album">
                            </div>
                    ...
                    <hr class="line-separator">
                        <div class="c24 phablet-c1 highlight text-content padding-10 margin-bottom-0">
                            ...
                            <p>Both language and username subdomains are highly experimental features that require
                                advanced server configurations. The alleged functionalities should be enabled only after
                                setting up a subdomain wildcard pointing to your Chevereto installation. You also need
                                to enable CORS for these subdomains. If you want to use HTTPS, you also need to bind the
                                SSL certificate(s) for your subdomains.</p>
                            <p><b>Don't ask us how to make this work for your installation.</b> These are experimental
                                features, and we don't have any guidance on how to fulfill the server requirements
                                listed above as we are still collecting feedback from pro users. We will publish
                                instructions (if any) in the future.</p>
                        </div>
                        <div class="input-label">
                            <label for="hostname"><?php _se('Hostname'); ?></label>
                            <div class="c9 phablet-c1">
                                <input type="text" name="hostname" id="hostname" class="text-input"
                                       value="<?php echo CHV\Settings::get('hostname', true); ?>"
                                       pattern="^(?!:\/\/)([a-zA-Z0-9-_]+\.)*[a-zA-Z0-9][a-zA-Z0-9-_]+\.[a-zA-Z]{2,11}?$"
                                       placeholder="<?php echo G\get_domain(G_HTTP_HOST); ?>">
                            </div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="lang_subdomain_wildcard"
                                                               id="lang_subdomain_wildcard" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="user_subdomain_wildcard"
                                                               id="user_subdomain_wildcard" class="text-input">
                                    <?php
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="default_language" id="default_language"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="auto_language" id="auto_language"
                                                               class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="language_chooser_enable"
                                                               id="language_chooser_enable" class="text-input"
                                                               data-combo="language-enable-combo">
                                    <?php
                    ...
                    $icon_template = '<span rel="toolTip" data-tipTip="right" title="%TITLE%" class="cursor-pointer icon %ICON%" data-checked-icon="' . $checkbox_icons[1] . '" data-unchecked-icon="' . $checkbox_icons[0] . '" data-action="toggle-storage-%PROP%" data-checkbox></span>'; ?>
                        ...
                        <ul data-content="dashboard-storages-list"
                            class="tabbed-content-list table-li margin-top-20 margin-bottom-20">
                            <li class="table-li-header phone-hide">
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="text" name="email_from_name" id="email_from_name"
                                                              class="text-input"
                                                              value="<?php echo CHV\Settings::get('email_from_name', true); ?>"
                                                              required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="email" name="email_from_email" id="email_from_email"
                                                              class="text-input"
                                                              value="<?php echo CHV\Settings::get('email_from_email', true); ?>"
                                                              required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="email" name="email_incoming_email"
                                                              id="email_incoming_email" class="text-input"
                                                              value="<?php echo CHV\Settings::get('email_incoming_email', true); ?>"
                                                              required></div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="email_mode" id="email_mode"
                                                               class="text-input" data-combo="mail-combo">
                                    <?php
                        ...
                        <div id="mail-combo">
                            ...
                            <div data-combo-value="smtp"
                                    ...
                                    <div class="overflow-auto">
                                        <div class="c7 float-left">
                                            <input type="text" name="email_smtp_server" id="email_smtp_server"
                                                   class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['email_smtp_server'] : CHV\Settings::get('email_smtp_server'); ?>"
                                                   placeholder="<?php _se('SMTP server'); ?>">
                                        </div>
                                        <div class="c2 float-left margin-left-10">
                                            <select type="text" name="email_smtp_server_port"
                                                    id="email_smtp_server_port" class="text-input">
                                                <?php
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="email_smtp_server_username" id="email_smtp_server_username"
                                           class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['email_smtp_server_username'] : CHV\Settings::get('email_smtp_server_username'); ?>">
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="password" name="email_smtp_server_password"
                                           id="email_smtp_server_password" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['email_smtp_server_password'] : CHV\Settings::get('email_smtp_server_password'); ?>">
                                ...
                                <div class="input-label c5">
                                    ...
                                    <select type="text" name="email_smtp_server_security"
                                            id="email_smtp_server_security" class="text-input">
                                        <?php
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="phablet-c1">
                                <input type="text" data-dashboard-tool="decodeId" name="decode-id" id="decode-id"
                                       class="c4 text-input" placeholder="<?php echo CHV\encodeID(1337); ?>"> <a
                                        class="btn btn-input default" data-action="dashboardTool" data-tool="decodeId"
                                        data-data='{"id":"#decode-id"}'><span
                                            class="loading display-inline-block"></span><span
                                            class="text"><?php _se('Decode ID'); ?></span></a>
                            </div>
                        </div>
                        <div class="input-label">
                            <label for="encode-id"><?php _se('Encode ID'); ?></label>
                            <div class="phablet-c1">
                                <input type="number" data-dashboard-tool="encodeId" min="0" name="encode-id"
                                       id="encode-id" class="c4 text-input" placeholder="1234"> <a
                                        class="btn btn-input default" data-action="dashboardTool" data-tool="encodeId"
                                        data-data='{"id":"#encode-id"}'><span
                                            class="loading display-inline-block"></span><span
                                            class="text"><?php _se('Encode ID'); ?></span></a>
                            </div>
                        </div>
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="phablet-c1">
                                <input type="email" data-dashboard-tool="testEmail" name="test-email" id="test-email"
                                       class="c4 text-input" placeholder="test@mail.com"> <a
                                        class="btn btn-input default" data-action="dashboardTool" data-tool="testEmail"
                                        data-data='{"email":"#test-email"}'><span
                                            class="loading display-inline-block"></span><span
                                            class="text"><?php _se('Send test email'); ?></span></a>
                            </div>
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="phablet-c1">
                                <input type="text" data-dashboard-tool="exportUser" name="export-user" min="1"
                                       id="export-user" class="c4 text-input" placeholder="<?php _se('Username'); ?>">
                                <a class="btn btn-input default" data-action="dashboardTool" data-tool="exportUser"
                                   data-data='{"username":"#export-user"}'><span
                                            class="loading display-inline-block"></span><span
                                            class="text"><?php _se('Export user'); ?></span></a>
                            </div>
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="phablet-c1">
                                <input type="number" data-dashboard-tool="regenStorageStats" min="0" step="1"
                                       name="storageId" id="storageId" class="c4 text-input"
                                       placeholder="<?php _se('Storage id'); ?>"> <a class="btn btn-input default"
                                                                                     data-action="dashboardTool"
                                                                                     data-tool="regenStorageStats"
                                                                                     data-data='{"storageId":"#storageId"}'><span
                                            class="loading display-inline-block"></span>
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="phablet-c1">
                                <input type="number" data-dashboard-tool="migrateStorage" min="0" step="1"
                                       name="sourceStorageId" id="sourceStorageId" class="c5 text-input"
                                       placeholder="<?php _se('Source storage id'); ?>">
                                <input type="number" data-dashboard-tool="migrateStorage" min="0" step="1"
                                       name="targetStorageId" id="targetStorageId" class="c5 text-input"
                                       placeholder="<?php _se('Target storage id'); ?>">
                                <a class="btn btn-input default" data-action="dashboardTool" data-tool="migrateStorage"
                                   data-data='{"sourceStorageId":"#sourceStorageId", "targetStorageId":"#targetStorageId"}'>
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="facebook" id="facebook"
                                                               class="text-input" data-combo="facebook-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="facebook_app_id" id="facebook_app_id" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['facebook_app_id'] : CHV\Settings::get('facebook_app_id', true); ?>">
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="facebook_app_secret" id="facebook_app_secret"
                                           class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['facebook_app_secret'] : CHV\Settings::get('facebook_app_secret', true); ?>">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="twitter" id="twitter"
                                                               class="text-input" data-combo="twitter-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="twitter_api_key" id="twitter_api_key" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['twitter_api_key'] : CHV\Settings::get('twitter_api_key', true); ?>">
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="twitter_api_secret" id="twitter_api_secret"
                                           class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['twitter_api_secret'] : CHV\Settings::get('twitter_api_secret', true); ?>">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1">
                                <input type="text" name="twitter_account" id="twitter_account" class="text-input"
                                       placeholder="chevereto"
                                       value="<?php echo get_safe_post() ? get_safe_post()['twitter_account'] : CHV\Settings::get('twitter_account', true); ?>">
                            </div>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="google" id="google" class="text-input"
                                                               data-combo="google-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="google_client_id" id="google_client_id" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['google_client_id'] : CHV\Settings::get('google_client_id', true); ?>">
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="google_client_secret" id="google_client_secret"
                                           class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['google_client_secret'] : CHV\Settings::get('google_client_secret', true); ?>">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="vk" id="vk" class="text-input"
                                                               data-combo="vk-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="vk_client_id" id="vk_client_id" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['vk_client_id'] : CHV\Settings::get('vk_client_id', true); ?>">
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="vk_client_secret" id="vk_client_secret" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['vk_client_secret'] : CHV\Settings::get('vk_client_secret', true); ?>">
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="akismet" id="akismet"
                                                               class="text-input" data-combo="akismet-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="akismet_api_key" id="akismet_api_key" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['akismet_api_key'] : CHV\Settings::get('akismet_api_key', true); ?>">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="stopforumspam" id="stopforumspam"
                                                               class="text-input">
                                    <?php
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="cdn" id="cdn" class="text-input"
                                                               data-combo="cdn-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <input type="text" name="cdn_url" id="cdn_url" class="text-input"
                                           value="<?php echo get_safe_post() ? get_safe_post()['cdn_url'] : CHV\Settings::get('cdn_url', true); ?>"
                                           placeholder="http://something.netdna-cdn.com/">
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="recaptcha" id="recaptcha"
                                                               class="text-input" data-combo="recaptcha-combo">
                                    <?php
                            ...
                            <div data-combo-value="1"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c2 phablet-c1"><select type="text" name="recaptcha_version"
                                                                       id="recaptcha_version" class="text-input">
                                            <?php
                                ...
                                <div class="c9 phablet-c1">
                                    <div class="input-label">
                                        ...
                                        <input type="text" name="recaptcha_public_key" id="recaptcha_public_key"
                                               class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['recaptcha_public_key'] : CHV\Settings::get('recaptcha_public_key', true); ?>">
                                    ...
                                    <div class="input-label">
                                        ...
                                        <input type="text" name="recaptcha_private_key" id="recaptcha_private_key"
                                               class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['recaptcha_private_key'] : CHV\Settings::get('recaptcha_private_key', true); ?>">
                                ...
                                <div class="input-label">
                                    <div class="c9 phablet-c1">
                                        ...
                                        <div class="c2">
                                            <input type="number" min="0" name="recaptcha_threshold"
                                                   id="recaptcha_threshold" class="text-input"
                                                   value="<?php echo get_safe_post() ? get_safe_post()['recaptcha_threshold'] : CHV\Settings::get('recaptcha_threshold'); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c5 phablet-c1"><select type="text" name="force_recaptcha_contact_page"
                                                                       id="force_recaptcha_contact_page"
                                                                       class="text-input">
                                            <?php
                    ...
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="comments_api" id="comments_api"
                                                               class="text-input" data-combo="comments_api-combo">
                                    <?php
                                    echo CHV\Render\get_select_options_html([
                                        'disqus' => 'Disqus',
                                        'js' => 'JavaScript/HTML',
                                ...
                                <div class="c9 phablet-c1">
                                    <div class="input-label">
                                        ...
                                        <input type="text" name="disqus_shortname" id="disqus_shortname"
                                               class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['disqus_shortname'] : CHV\Settings::get('disqus_shortname', true); ?>">
                                    ...
                                    <div class="input-label">
                                        ...
                                        <input type="text" name="disqus_secret_key" id="disqus_secret_key"
                                               class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['disqus_secret_key'] : CHV\Settings::get('disqus_secret_key', true); ?>">
                                    ...
                                    <div class="input-label">
                                        ...
                                        <input type="text" name="disqus_public_key" id="disqus_public_key"
                                               class="text-input"
                                               value="<?php echo get_safe_post() ? get_safe_post()['disqus_public_key'] : CHV\Settings::get('disqus_public_key', true); ?>">
                            ...
                            <div data-combo-value="js"
                                ...
                                <div class="input-label">
                                    ...
                                    <div class="c12 phablet-c1"><textarea type="text" name="comment_code"
                                                                          id="comment_code" class="text-input r4"
                                                                          value=""
                                                                          placeholder="<?php _se('Disqus, Facebook or anything you want. It will be used in image view.'); ?>"><?php echo CHV\Settings::get('comment_code', true); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <hr class="line-separator">
                        <div class="input-label">
                            ...
                            <div class="c12 phablet-c1"><textarea type="text" name="analytics_code" id="analytics_code"
                                                                  class="text-input r4" value=""
                                                                  placeholder="<?php _se('Google Analytics or anything you want. It will be added to the theme footer.'); ?>"><?php echo CHV\Settings::get('analytics_code', true); ?></textarea>
                            </div>
                        </div>
                    <hr class="line-separator">
                        <div class="input-label">
                            <label for="cloudflare">Cloudflare</label>
                            <div class="c5 phablet-c1"><select type="text" name="cloudflare" id="cloudflare"
                                                               class="text-input">
                                    <?php
                    ...
                    ?>
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="text" name="api_v1_key" id="api_v1_key"
                                                              class="text-input"
                                                              value="<?php echo CHV\Settings::get('api_v1_key', true); ?>">
                            </div>
                    ...
                    ?>
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_plugin_route"
                                                               id="enable_plugin_route" class="text-input">
                                    <?php
                        ...
                        <div class="input-label">
                            ...
                            <div class="c9 phablet-c1"><input type="text" name="sdk_pup_url" id="sdk_pup_url"
                                                              class="text-input"
                    ...
                    <hr class="line-separator">
                        ...
                        <div class="input-label">
                            ...
                            <div class="c5 phablet-c1"><select type="text" name="enable_cookie_law"
                                                               id="enable_cookie_law" class="text-input">
                                    <?php
                        ...
                        if (is_show_submit()) {
                            ...
                            <div class="btn-container btn-container--fixed">
                                <div class="content-width">
                                    <button class="btn btn-input red"
                                            type="submit"><?php _se('Save changes'); ?></button>
                                </div>
                            </div>
                            <?php
                        } ?>
            ...
            ?>
                <form id="dashboard-settings" method="post" data-type="<?php echo get_dashboard(); ?>"
                    ...
                    <div class="input-label">
                        <label for="censor_type"><?php _se('Setting image censor interface'); ?></label>
                        <div class="c5 phablet-c1"><select type="text" name="censor_type" id="censor_type" class="text-input" data-combo="censor-combo">
                                <?php
                                echo CHV\Render\get_select_options_html([0 => _s('Disabled'), 1 => _s('Bai Du Ai'), 2 => _s('Tencent Ai'), 3 => _s('moderatecontent'), 4 => _s('Sightengine')], get_safe_post() ? get_safe_post()['censor_type'] : CHV\Settings::get('censor_type')); ?>
                            </select></div>
                        <div class="input-below"><?php _se('Setting image censor interface'); ?></div>
                    </div>
                        ...
                        <div data-combo-value="1" class="switch-combo<?php if (!(get_safe_post() ? get_safe_post()['censor_type'] : CHV\Settings::get('censor_type'))) {
                            ...
                            <div class="baidu">
                                <div class="input-label">
                                    ...
                                    <div class="c5"><input type="text" name="bd_censor_app_id" id="bd_censor_app_id" class="text-input" value="<?php echo CHV\Settings::get('bd_censor_app_id'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['bd_censor_app_id']; ?></div>
                                    <div class="input-below"><?php _se('BaiDu AI APPID,get Address: https://console.bce.baidu.com/ai/'); ?></div>
                                </div>
                                <div class="input-label">
                                    <label for="bd_censor_app_key"><?php _se('BaiDu AI APPKEY'); ?></label>
                                    <div class="c5"><input type="text" name="bd_censor_app_key" id="bd_censor_app_key" class="text-input" value="<?php echo CHV\Settings::get('bd_censor_app_key'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['bd_censor_app_key']; ?></div>
                                    <div class="input-below"><?php _se('BaiDu AI APPKEY,get Address: https://console.bce.baidu.com/ai/'); ?></div>
                                </div>
                                <div class="input-label">
                                    <label for="bd_censor_app_secret"><?php _se('BaiDu AI APPSECRET'); ?></label>
                                    <div class="c5"><input type="text" name="bd_censor_app_secret" id="bd_censor_app_secret" class="text-input" value="<?php echo CHV\Settings::get('bd_censor_app_secret'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['bd_censor_app_secret']; ?></div>
                                    <div class="input-below"><?php _se('BaiDu AI APPSECRET,get Address: https://console.bce.baidu.com/ai/'); ?></div>
                                </div>
                            </div>
                        ...
                        <div data-combo-value="2" class="switch-combo<?php if (!(get_safe_post() ? get_safe_post()['censor_type'] : CHV\Settings::get('censor_type'))) {
                            ...
                            <div class="tencent">
                                <div class="input-label">
                                    ...
                                    <div class="c5"><input type="text" name="tx_censor_app_id" id="tx_censor_app_id" class="text-input" value="<?php echo CHV\Settings::get('tx_censor_app_id'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['tx_censor_app_id']; ?></div>
                                    <div class="input-below"><?php _se('TenCent AI APPID get Address :https://ai.qq.com/'); ?></div>
                                </div>
                                <div class="input-label">
                                    <label for="tx_censor_app_key"><?php _se('TenCent AI APPKEY'); ?></label>
                                    <div class="c5"><input type="text" name="tx_censor_app_key" id="tx_censor_app_key" class="text-input" value="<?php echo CHV\Settings::get('tx_censor_app_key'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['tx_censor_app_key']; ?></div>
                                    <div class="input-below"><?php _se('TenCent AI APPKEY get Address :https://ai.qq.com/'); ?></div>
                                </div>
                            </div>
                        ...
                        <div data-combo-value="3" class="switch-combo<?php if (!(get_safe_post() ? get_safe_post()['censor_type'] : CHV\Settings::get('censor_type'))) {
                            ...
                            <div class="moderatecontent">
                                <div class="input-label">
                                    ...
                                    <div class="c5"><input type="text" name="mc_censor_api_key" id="mc_censor_api_key" class="text-input" value="<?php echo CHV\Settings::get('mc_censor_api_key'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['mc_censor_api_key']; ?></div>
                                    <div class="input-below"><?php _se('Moderatecontent Key,get Address : https://www.moderatecontent.com/'); ?></div>
                                </div>
                            </div>
                        ...
                        <div data-combo-value="4" class="switch-combo<?php if (!(get_safe_post() ? get_safe_post()['censor_type'] : CHV\Settings::get('censor_type'))) {
                            ...
                            <div class="sightengine">
                                <div class="input-label">
                                    ...
                                    <div class="c5"><input type="text" name="se_censor_user" id="se_censor_user" class="text-input" value="<?php echo CHV\Settings::get('se_censor_user'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['mc_censor_api_key']; ?></div>
                                    <div class="input-below"><?php _se('Sightengine User,get Address : https://sightengine.com/'); ?></div>
                                </div>
                                <div class="input-label">
                                    <label for="se_censor_secret"><?php _se('Sightengine Secret'); ?></label>
                                    <div class="c5"><input type="text" name="se_censor_secret" id="se_censor_secret" class="text-input" value="<?php echo CHV\Settings::get('se_censor_secret'); ?>" placeholder="/"></div>
                                    <div class="input-below input-warning red-warning"><?php echo get_input_errors()['mc_censor_api_key']; ?></div>
                                    <div class="input-below"><?php _se('Moderatecontent Key,get Address : https://sightengine.com/'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-label">
                        <label for="pron_mode"><?php _se('Pron image process mode'); ?></label>
                        <div class="c5 phablet-c1"><select type="text" name="pron_mode" id="pron_mode" class="text-input">
                                <?php
                                echo CHV\Render\get_select_options_html([0 => _s('none mode'), 1 => _s('del'), 2 => _s('make unhealthy')], CHV\Settings::get('pron_mode')); ?>
                            </select></div>
                        <div class="input-below"><?php _se('Pron image process mode'); ?></div>
                    </div>
                    <div class="input-label">
                        <label for="suspect_mode"><?php _se('Suspect pron image process mode'); ?></label>
                        <div class="c5 phablet-c1"><select type="text" name="suspect_mode" id="suspect_mode" class="text-input">
                                <?php
                                echo CHV\Render\get_select_options_html([0 => _s('none mode'), 1 => _s('del'), 2 => _s('make unhealthy')], CHV\Settings::get('suspect_mode')); ?>
                            </select></div>
                    ...
                    <div class="input-label">
                        ...
                        <div class="input-below"><?php _se('Censor fail image process mode'); ?></div>
                    </div>
                    <hr class="line-separator">
